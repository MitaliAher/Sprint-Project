...
export class AdminComponent implements OnInit {
  ...
  AddProduct()
  {
    ...
    this.httpc.post("https://localhost:44326/api/Product",admindto).subscribe(res=>this.PostSuccess(res),res=>this.PostError(res));
  ...
  Show(){
    console.log("Hi");
    this.httpc.get("https://localhost:44326/api/Product").subscribe(res=>this.GetSuccess(res),res=>this.GetError(res));
  }
